...
`representative_image` が空の項目を一覧表示します。現在は120項目すべてに代表画像が設定済みです。
...
現在120項目を登録済みです。初期20項目に加えて、建造物・都市・土木・塔・墓所・水場・産業インフラから逆引きしやすい視覚カテゴリを追加しています。
...
現在の辞書は120項目です。初期20項目、建造物系の追加カテゴリ、さらに構造物・都市・建築空間・塔・墓所・水場・産業インフラから逆引きしやすい75項目を含みます。

代表画像は120項目すべてに設定済みです。今回追加した20項目も `app/generated/representatives/` の生成画像を参照します。追加内容の概要は `docs/structure-expansion-100.md` に追記しています。
