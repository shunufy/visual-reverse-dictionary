...
`representative_image` が空の項目を一覧表示します。現在は140項目すべてに代表画像が設定済みです。
...
現在140項目を登録済みです。初期20項目に加えて、建造物・都市・土木・塔・墓所・水場・産業インフラ・門・記念物・劇場・水処理施設から逆引きしやすい視覚カテゴリを追加しています。
...
建造物系語彙の命名方針と使い分けは [docs/building-visual-categories.md](F:/codex/マイクラモッド系/モッド改造/visual-reverse-dictionary/docs/building-visual-categories.md) と [docs/structure-expansion-100.md](F:/codex/マイクラモッド系/モッド改造/visual-reverse-dictionary/docs/structure-expansion-100.md) にまとめています。
...
現在の辞書は140項目です。初期20項目、建造物系の追加カテゴリ、さらに構造物・都市・建築空間・塔・墓所・水場・産業インフラ・門・記念物・劇場から逆引きしやすい95項目を含みます。

代表画像は140項目すべてに設定済みです。追加した構造物系項目も `app/generated/representatives/` の生成画像を参照します。追加内容の概要は `docs/structure-expansion-100.md` に追記しています。
